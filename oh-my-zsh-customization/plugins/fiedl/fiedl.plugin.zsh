...
unalias g
function g () { tput rmam; grep --exclude-dir log --exclude-dir tmp --exclude-dir .yardoc --exclude-dir doc --exclude-dir coverage --exclude-dir vendor --recursive --line-number "$*" . ; tput smam }  # --ignore-case
